...
****************************************/
    ...
    #define EZI2C_1_EZI2C_FIFO_SIZE EZI2C_1_GET_FIFO_SIZE(EZI2C_1_EZI2C_BYTE_MODE_ENABLE)
...
typedef struct
{
    ...
    */
     ...
     *  - EZI2C_1_EZI2C_ONE_ADDRESS
     *  - EZI2C_1_EZI2C_TWO_ADDRESSES
    */
    ...
    */
    ...
    /** Size of sub-address.
     *  - EZI2C_1_EZI2C_SUB_ADDR8_BITS 
     *  - EZI2C_1_EZI2C_SUB_ADDR16_BITS
    */
    uint32 subAddrSize;
    ...
    */
    ...
    /** When enabled the TX and RX FIFO depth is 16 bytes: 0 每 disable, 
     *  1 每 enable.
     * 
...
#define EZI2C_1_EZI2C_TX_CTRL  ((EZI2C_1_ONE_BYTE_WIDTH - 1u) | \
