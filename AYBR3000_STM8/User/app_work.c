...
static App_mode_config mode_configs[APP_MODE_NUMBER] = 
{
    ...
    {APP_QIANG_RUO_CONFIG_B, ENABLE , {DISABLE, 0 , 0 , 0 }, {ENABLE, 30, 60 , 30 }},//APP_MODE_XIN_FENG,
    {APP_QIANG_RUO_CONFIG_C, ENABLE , {ENABLE,  30, 40, 35}, {ENABLE, 60, 120, 90 }},//APP_MODE_XIN_FENG_QU_NUAN,w
    {APP_QIANG_RUO_CONFIG_B, DISABLE, {DISABLE, 0 , 0 , 0 }, {ENABLE, 15, 60 , 30 }},//APP_MODE_HUAN_QI,
